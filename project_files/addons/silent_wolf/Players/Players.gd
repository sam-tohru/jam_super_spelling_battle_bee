...
func save_player_data(player_name: String, player_data: Dictionary, overwrite: bool=true) -> Node:
	...
	var payload = { "game_id": SilentWolf.config.game_id, "game_version": SilentWolf.config.game_version, "player_name": player_name, "player_data": player_data, "overwrite": overwrite }
